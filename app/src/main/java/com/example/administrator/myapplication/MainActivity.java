...
public class MainActivity extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initData();
        mRecylerView.addItemDecoration(new MenuItemDecoration(this));
        mRecylerView.setLayoutManager(mLinearLayoutManager);
        mAdapter = new MenuAdapter(this,mDataList);
        ...
        mRecylerView.addOnScrollListener(new MenuOnScrollListener() {
            @Override
            public void loadMore() {
                mHandler.postDelayed(new Runnable() {
                    ...
                    public void run() {
                        ...
                        mRecylerView.smoothScrollToPosition(mDataList.size()-1);
                    }
                },2000);
            }
        });
